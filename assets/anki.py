...
_RESOURCE_CSS = _BASE_CSS + " .resource { font-size: 14px; color: #06c; margin-top: 8px; word-break: break-all; }"
...
def cmd_add_notes(path):
    ...
    valid, skipped = [], []
    for n, ok in zip(notes, can_add):
        (valid if ok else skipped).append(n)
